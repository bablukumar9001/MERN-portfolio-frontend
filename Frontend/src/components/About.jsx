              ...
              <section id="home" className="banner-wrapper">
                <div className="container ">
                  ...
                  <p className="mt-1 textt">
                    <span className="ivertedcomaa">"</span>I am Bablu kumar. I'm
                    a full stack developer based in India. I love combining the
                    ...
                    are seeking a web presence or an employer looking to hire,
